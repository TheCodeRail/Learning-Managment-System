            ...
            <div className="flex items-center gap-4">
              <DropdownMenu>
                <DropdownMenuTrigger>
                  {" "}
                  <Avatar>
                    <AvatarImage src="https://cdna.artstation.com/p/assets/images/images/040/951/926/large/maddie_creates-jj-ver2.jpg?1630351796" />
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuItem className="cursor-pointer">
                    <Link to="/admin/addWeek">Add Weeks</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="cursor-pointer">
